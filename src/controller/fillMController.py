...
class FillMController():
    ...
    estaBol=["M0009"]
    """ ["M0001", "M0009", "M0021", "M0023", "M0024", "M0105", "M0310", "M0318", "M0321", "M0328", "M0337", "M0343", "M0344",
    ...
    def getSerie(self,añoiN,añofN,codEsta = estaBol, rutadbf="/" ,tabla="V0001",rutanc="/", añonc=1981,varnc="precipitation"):
        ...
        for es in codEsta:
            ...
            serie = self.conecmch.getSerie(estaConsul.iat[0, 0], añoiN, añofN, tabla)
            #print(serie)
            print("latitud",estaConsul.iat[0, 3],"  longitud ",estaConsul.iat[0, 4])
            ncfill=self.fillWhitNC(añoiN,añofN,serie,rutaNC=rutanc,añonc=añoiN,latEst=estaConsul.iat[0, 3],lonEst=estaConsul.iat[0, 4],varnc=varnc)
            #normalesdf = normalesdf.append(estaConsul)
        # print("fin del metodo.....")
        #return normalesdf

    def fillWhitNC(self, añoI,añoF,serie,rutaNC, añonc,latEst,lonEst, varnc):
...
varnc="precipitation"
nc=bc.getSerie(1981,2017,listado,rdbf,tabla="V0001",rutanc="/home/drosero/Descargas/rrchirps.nc",varnc=varnc)
nc.to_csv((rs+"RRChirps"), sep=';', encoding='utf-8')
#print(nc)